...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tech_In.Models.Database.AIUserInterest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("AIUserInterest");
                });

            modelBuilder.Entity("Tech_In.Models.Database.Applicant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Tech_In.Models.Database.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Tech_In.Models.Database.ArticleCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Tech_In.Models.Database.ArticleComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Tech_In.Models.Database.ArticleTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Tech_In.Models.Database.ArticleVisitor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Tech_In.Models.Database.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Tech_In.Models.Database.Job", b =>
                {
                    ...
                    b.Property<int>("MaxExpereince");

                    b.Property<int>("MaxSalary");

                    b.Property<int>("MinExpereince");
            ...
            modelBuilder.Entity("Tech_In.Models.Database.JobCatagory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Tech_In.Models.Database.JobSkill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Tech_In.Models.Database.SavedJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Tech_In.Models.Database.UserQuestion", b =>
                {
                    ...
                    b.Property<bool>("HasVerifiedAns");
            ...
            modelBuilder.Entity("Tech_In.Models.Database.AIUserInterest", b =>
                {
                    b.HasOne("Tech_In.Models.Database.SkillTag", "TagRef")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Tech_In.Models.Database.Applicant", b =>
                {
                    b.HasOne("Tech_In.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("AppliedBy");

                    b.HasOne("Tech_In.Models.Database.Job", "Job")
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Tech_In.Models.Database.ArticleCategory", b =>
                {
                    b.HasOne("Tech_In.Models.Database.Article", "ArticleRef")
                        .WithMany()
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Tech_In.Models.Database.Category", "CategoryRef")
                        .WithMany()
            ...
            modelBuilder.Entity("Tech_In.Models.Database.Job", b =>
                {
                    ...
                    b.HasOne("Tech_In.Models.Database.Company", "Company")
                        .WithMany("Jobs")
            ...
            modelBuilder.Entity("Tech_In.Models.Database.JobCatagory", b =>
                {
                    ...
                    b.HasOne("Tech_In.Models.Database.Job", "JobRef")
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Tech_In.Models.Database.SavedJob", b =>
                {
                    b.HasOne("Tech_In.Models.Database.Job", "JobId")
                        .WithMany()
                        .HasForeignKey("Job")
                        .OnDelete(DeleteBehavior.Cascade);
